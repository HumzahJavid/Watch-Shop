...
<!--<script src="productImages.js">
    ...
    <div class="grid_element"  >
        <img id="image1" src="images/product/1.png" style="width:100%;height:100%" onmouseover="images/info/1.png" onmouseout="images/product/1.png" alt="Another image">
        <p>Description of above image</p>
    </div>
    <div class="grid_element" id="image2">
        <img src="images/product/2.png" style="width:100%;height:100%" onmouseover="this.src = 'images/info/2.png'" onmouseout="this.src = 'images/product/2.png'" alt="Another image">
        <p>Description of above image</p>
    </div>
    <div class="grid_element" id="image3">
        <img src="images/product/3.png" style="width:100%;height:100%" onmouseover="this.src = 'images/info/3.png'" onmouseout="this.src = 'images/product/3.png'" alt="Another image">
        <p>Description of above image</p>
    </div>
    <div class="grid_element" id="image4">
        <img src="images/product/4.png" style="width:100%;height:100%" onmouseover="this.src = 'images/info/4.png'" onmouseout="this.src = 'images/product/4.png'" alt="Another image">
        <p>Description of above image</p>
    </div>
    <div class="grid_element">
        <img src="images/product/5.png" style="width:100%;height:100%" onmouseover="this.src = 'images/info/5.png'" onmouseout="this.src = 'images/product/5.png'" alt="Another image">
        <p>Description of above image</p>
    </div>
    <div class="grid_element">
	...
	/*function swapImages(x) {
		switch (x) {
			...
			case 2:
			document.getElementById("image1").src = "images/product/2.png"
			break;
